...
public class History_CarIn_Data_Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        String date = list.getTran_carin_cabinet_send_time();
        String cabinet_id = list.getTran_carin_cabinet_id();
        String cabinet_code = list.getTran_carin_cabinet_code();
        String building_id  = list.getTran_carin_building_id();
        String building_code  = list.getTran_carin_building_code();
